...
export default function CourseAccordionBar({ course, isActive, handleActive }) {
  ...
  return (
    <div className='overflow-hidden border border-solid border-richblack-600 bg-richblack-700 hover:bg-richblack-600 text-richblack-5 last:mb-0 duration-200 '>
      <div>
        <div
          className={`flex cursor-pointer items-start justify-between bg-opacity-20 px-5 py-3 transition-[0.3s]`}
      ...
      >
        <div className="text-textHead flex flex-col gap-2 px-4 py-1">
