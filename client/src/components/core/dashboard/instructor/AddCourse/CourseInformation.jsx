    ...
    <div className="bg-richblack-800 rounded-md p-6">
      ...
      >
        ...
        <label className="flex flex-col gap-1 text-richblack-5 text-sm relative">
          ...
          />
          <HiOutlineCurrencyRupee className="absolute top-1/2 left-2 inline-block text-2xl text-richblack-400" />
        </label>
        <label className="flex flex-col gap-1 text-richblack-5 text-sm">
          <p>
        ...
        <div className="flex gap-3">
          <button
            className="bg-yellow-50 w-fit px-6 py-3 rounded-md flex items-center gap-2"
            type="submit"
          >
            Next
          ...
          <button
            className="bg-richblack-700 text-richblack-50 w-fit px-6 py-3 rounded-md flex items-center gap-2"
