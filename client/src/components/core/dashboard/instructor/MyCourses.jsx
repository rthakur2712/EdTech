  ...
  return (
    <div className="mx-10 my-5 space-y-10">
      <div className="flex justify-between">
        ...
        <div
          className="bg-yellow-50 w-fit px-4 py-2 rounded-md flex items-center gap-1 cursor-pointer"
      ...
      <Table className="rounded-lg border border-richblack-800 ">
        <Thead>
          <Tr className="flex gap-x-10 rounded-t-3xl border-b border-b-richblack-800 px-6 py-2">
            <Th className="w-[70%] text-left text-sm font-medium uppercase text-richblack-100">
              Courses
            </Th>
          ...
          {courses &&
            courses.map((item) => {
              return (
                <Tr
                  key={item._id}
                  className="flex gap-x-10 border-b border-richblack-800 px-6 py-6 items-center"
                >
