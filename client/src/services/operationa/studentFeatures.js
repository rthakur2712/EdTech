...
export async function buyCourse(token, coursesId, userDetails, navigate, dispatch){
    ...
    try{
        ...
        const orderResponse = await apiConnector("POST",studentEndpoints.COURSE_PAYMENT_API,{coursesId},
...
async function verifyPayment(bodyData, token, navigate, dispatch) {
    ...
    try {
        const response = await apiConnector("POST", studentEndpoints.VERIFY_PAYMENT_API, bodyData, {
            Authorization: `Bearer ${token}`,
        })
